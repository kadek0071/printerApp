		...
		<div class="web-center-content">
			...
			<div class="login-container">	
					...
					<div id="form-container" class="forms form1">
						<form id="form1" action="DATABASE_HAND/login.php" method="POST" novalidate>
							...
							<div class="pass-forger-parent">
								<a class="pass-forget" href="reset-password.php">Zapomniałeś hasło?</a>
							</div>
				...
				<div id="form-container-2" class="forms form2">
					<form id="form2" action="DATABASE_HAND/signup.php" method="POST" novalidate autocomplete="off">
						<div class="input-div">
							<div class="i">
									<i class="fas fa-user"></i>
							</div>
							<div class="div">
									...
									<?php
										if(isset($_GET['name'])){
											$name = $_GET['name'];
											echo '<input type="text" id="nazwa_value_2" class="input" name="nazwa_2" value="'.$name.'">';
										} else{
											echo '<input type="text" id="nazwa_value_2" class="input" name="nazwa_2">';											
										}									
									?>									
									<small>Error message</small>
							...
							<div class="div">
									...
									<?php
										if(isset($_GET['login_2'])){
											...
											echo '<input type="text" id="login_value_2" class="input" name="login_2" value="'.$login_2.'">';
										} else{
											echo '<input type="text" id="login_value_2" class="input" name="login_2">';											
										}									
									?>										
									<small>Error message</small>
							</div>
							...
							<div class="div">
									...
									<?php
										if(isset($_GET['email_2'])){
											...
											echo '<input type="text" id="email_value_2" class="input" name="email_2" value="'.$email_2.'">';
										} else{
						...
						<div class="input-div">
							...
							<div class="div">
								<h5>Hasło</h5>
								<input type="password" id="password_value_2" class="input" name="pass_2">
								<small>Error message</small>
								<div class="i-eye"> 
						...
						<div class="input-div">
							...
							<div class="div">
								<h5>Powtórz hasło</h5>
								<input type="password" id="password_value_2_repeat" class="input" name="pass_repeat_2">
